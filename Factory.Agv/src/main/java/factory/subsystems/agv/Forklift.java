...
public class Forklift implements Placeable {
	...
	public Forklift(Position pos, AgvCoordinator coordinator) {
		...
		forkliftImage = new ImageIcon("src/main/resources/Forklift-v3.png").getImage();
		forkliftImageLoaded = new ImageIcon("src/main/resources/Forklift-v3-loaded.png").getImage();
	}
