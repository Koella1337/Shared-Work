...
import factory.app.gui.GUIHandlerImpl;
import factory.app.gui.UIConfiguration;
...
public class FactoryApplication implements Stoppable {
	...
	private void initFactoryFromXML(Document layoutDoc) {
		...
		UIConfiguration uiConfig = getUiConfigFromFactoryElement(factory);
		this.monitor = new MonitoringSystem();
		this.monitor.setGUIHandler(new GUIHandlerImpl(this.monitor, uiConfig));
